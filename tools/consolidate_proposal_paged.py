...
<div class="toc-block">
  ...
  <p class="toc-entry level-2"><a href="#sec1">Section 1: Dataset</a><span class="toc-page">{p_ch3 + 4}</span></p>
  <p class="toc-entry level-2"><a href="#sec2">Section 2: Procedure / Experiment</a><span class="toc-page">{p_ch3 + 13}</span></p>
  <p class="toc-entry level-2"><a href="#sec3">Section 3: System Testing</a><span class="toc-page">{p_ch3 + 21}</span></p>
...
<div class="toc-block" id="list-of-tables" style="page-break-before: always;">
  ...
  <p class="toc-entry"><a href="#table-3-1">Table 3.1: Study evaluation machines</a><span class="toc-page">{p_ch3 + 2}</span></p>
  <p class="toc-entry"><a href="#table-3-2">Table 3.2: SynapseOS minimum deployment requirements</a><span class="toc-page">{p_ch3 + 3}</span></p>
</div>

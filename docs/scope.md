...
- `[ ]` **D19/D20 (CLI mode, GUI-mode XFCE fallback) not yet reflected in SA3.1.** Table 3.1, Table 3.2, the paragraph following Table 3.2, and Section 3.5 (Threats to Validity) all currently describe only TUI and GUI mode, and GUI mode's Section 3.5 entry doesn't exist yet — the fallback and its logging/exclusion mitigation need a new Internal Validity entry there. Recorded 2026-07-10; archived pre-revision snapshot at `research-methods/archive/submitted-2026-07-10/`.
